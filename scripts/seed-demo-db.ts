...
const workspace = {
  id: "ws-lucyweb-demo",
  slug: "lucyweb",
  name: "MC Lucy Website Launch",
  description:
    "Static public read-only demo workspace for the MC Lucy website. This dataset showcases how Mission Control looks during a real project in progress.",
  mode: "demo",
  readOnly: true,
...
const tasks: SeedTask[] = [
  ...
  },
  {
    ...
    title: "Landing Page",
    description:
      "Create the public landing page explaining MC Lucy, its value proposition, and its mission control philosophy.",
    status: "DONE",
    priority: "P1",
  ...
  },
  {
    ...
    title: "Story Page",
    description:
      "Write and structure the human story behind MC Lucy, including the frustration, Claudio's role, the naming logic, and the invisible work philosophy.",
    status: "IN_PROGRESS",
    priority: "P2",
  ...
  },
  {
    ...
    slug: "manual-page",
    title: "Manual Page",
    description: "Explain how MC Lucy works in a clear, friendly, and practical way for first-time users.",
    status: "REVIEW",
    priority: "P2",
  ...
  },
  {
    ...
    description: "Implement the Get MC Lucy page and the launch pricing narrative around the $3/month annual story.",
    status: "BACKLOG",
    priority: "P2",
    ownerAgentId: "agent-lucy",
    createdByAgentId: "agent-claudio",
  ...
  },
  {
    ...
    description:
      "Prepare the thank-you page and installation prompt flow that lets OpenClaw install MC Lucy automatically after purchase.",
    status: "BLOCKED",
    priority: "P2",
    ownerAgentId: "agent-ninja",
    createdByAgentId: "agent-claudio",
...
async function main() {
  ...
  await prisma.run.create({
    data: {
      ...
      resultSummary: "Loaded static MC Lucy website launch demo dataset.",
